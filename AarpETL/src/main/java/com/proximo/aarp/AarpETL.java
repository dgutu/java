	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	if (!dm.getmETLStillRun()) {
	        	...
	        	// API URL
	        	String etlProcessTypeSource = builJsonURL(String.valueOf(since),String.valueOf(page),ConfigurationManager.jsonlimit,ConfigurationManager.jsonkey);
	        	...
	        	while(true) {
					...
					// debug
					logger.debug("page=" + page + ";item.size=" + dm.getProcessing().getJsonArray().size() + ";gettime=" + (etEnd-etStart));
					page++;
					totalEt += (etEnd-etStart)/1000;
