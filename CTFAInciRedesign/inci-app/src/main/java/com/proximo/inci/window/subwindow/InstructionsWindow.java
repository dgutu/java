...
import com.proximo.inci.view.home.intro.InstructionsLayout;
import com.proximo.inci.window.main.MainWindow;
import com.vaadin.ui.Label;
import com.vaadin.ui.VerticalLayout;

@SuppressWarnings("serial")
public class InstructionsWindow extends SubWindow {

    private static final String CAPTION_KEY = "introductionsWindow.caption";

    private static final String WIDTH = "950px";
    private static final String HEIGHT = "600px";

    public InstructionsWindow(MainWindow mainWindow) {
        super(mainWindow);
    }
    ...
    protected void addContent() {
        ...
        layout.addComponent(new InstructionsLayout(mainWindow));
    }
