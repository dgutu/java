...
public class EntryDateFromField extends AbstractInciFieldComponent<PopupDateField> {

    public EntryDateFromField() {
        build();
    }
    ...
    @Override
    protected void init() {
        //mainComponent.setCaption(CaptionResolver.getCaption("tradeName.search.entryDateField"));
