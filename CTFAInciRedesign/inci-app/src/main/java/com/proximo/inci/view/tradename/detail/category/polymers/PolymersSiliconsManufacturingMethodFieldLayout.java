...
public class PolymersSiliconsManufacturingMethodFieldLayout extends TradeNameColumnDetailsFieldLayout<VerticalLayout> {
    ...
    public PolymersSiliconsManufacturingMethodFieldLayout(TradeNameColumnDetails parentColumnDetails) {
    ...
    protected void init() {
        ...
        manufacturingMethodFieldDescriptionLabel1 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.polymersSilicons.description1", "very-small-text");
        manufacturingMethodFieldDescriptionLabel2 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.polymersSilicons.description2", "very-small-text");
        manufacturingMethodFieldDescriptionLabel3 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.polymersSilicons.description3", "very-small-text");
        manufacturingMethodFieldDescriptionLabel4 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.polymersSilicons.description4", "very-small-text");
