...
public class IdentityOfMaterialField extends TradeNameColumnDetailsField<TextArea> {

    public IdentityOfMaterialField(IdentityOfMaterialFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("tradeName.detail.identityOfMaterialField.DESC");
    }
