...
public class StateProvinceField extends AbstractInciFieldComponent<TextField> {

    private AbstractCreditCardDetailLayout creditCardDetailLayout;

    public StateProvinceField(AbstractCreditCardDetailLayout creditCardDetailLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("credit_card.detail.state_province"));
    }

    @Override
    public void generateContent() {
        DOUserCC userCC = creditCardDetailLayout.getUserCC();
        if (userCC != null && !TemplarUtil.isStringNullOrEmpty(userCC.state)) {
            setValue(userCC.state);
        } else {
            setValue("");
        }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("credit_card.detail.state_province.DESC");
    }
