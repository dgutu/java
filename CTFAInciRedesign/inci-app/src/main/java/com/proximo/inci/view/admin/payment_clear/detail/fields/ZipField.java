...
public class ZipField extends AbstractInciFieldComponent<TextField> {
    ...
    public ZipField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.zip"));
    }
