...
public class FirstNameField extends AbstractInciFieldComponent<TextField> {
    ...
    public FirstNameField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.first_name"));        
    }
