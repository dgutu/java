...
import com.proximo.inci.view.home.intro.ContactLayout;
import com.proximo.inci.window.main.MainWindow;
import com.vaadin.ui.Label;
import com.vaadin.ui.VerticalLayout;

@SuppressWarnings("serial")
public class ContactWindow extends SubWindow {

    private static final String CAPTION_KEY = "contactWindow.caption";

    private static final String WIDTH = "950px";
    private static final String HEIGHT = "600px";

    public ContactWindow(MainWindow mainWindow) {
        super(mainWindow);
    }
    ...
    protected void addContent() {
        ...
        layout.addComponent(new ContactLayout(mainWindow));
    }
