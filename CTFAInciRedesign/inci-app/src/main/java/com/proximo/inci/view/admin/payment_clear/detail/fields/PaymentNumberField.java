...
public class PaymentNumberField extends AbstractInciFieldComponent<TextField> {

    private AbstractPaymentClearInfoLayout paymentClearInfoLayout;

    public PaymentNumberField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption(paymentClearInfoLayout.getNumberFieldCaptionKey()));
    }
