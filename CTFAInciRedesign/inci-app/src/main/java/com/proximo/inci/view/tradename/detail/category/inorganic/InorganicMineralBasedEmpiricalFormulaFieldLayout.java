...
public class InorganicMineralBasedEmpiricalFormulaFieldLayout extends TradeNameColumnDetailsFieldLayout<VerticalLayout> {

    private LabelComponent empiricalFormulaFieldLabel;
    private EmpiricalFormulaField empiricalFormulaField;

    public InorganicMineralBasedEmpiricalFormulaFieldLayout(TradeNameColumnDetails parentColumnDetails) {
