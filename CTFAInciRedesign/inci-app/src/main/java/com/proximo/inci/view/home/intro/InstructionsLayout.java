...
public class InstructionsLayout extends VerticalLayout {
    
    private MainWindow mainWindow;
    private String fileName = "completeDetails.html";

    public InstructionsLayout(MainWindow mainWindow) {
        this.mainWindow = mainWindow;
        
        init();
    }
    
    public InstructionsLayout(MainWindow mainWindow, String fileName) {
        this.mainWindow = mainWindow;
