...
public class BiotechBioengineeringCompositionStatementFieldLayout extends
    ...
    public BiotechBioengineeringCompositionStatementFieldLayout(TradeNameColumnDetails parentColumnDetails) {
    ...
    protected void init() {
        ...
        compositionStatementFieldDescriptionLabel1 = new LabelComponent(
                "tradeName.detail.compositionStatementField.biotech.description1", "very-small-text");
        compositionStatementFieldDescriptionLabel2 = new LabelComponent(
                "tradeName.detail.compositionStatementField.biotech.description2", "very-small-text");
        compositionStatementFieldDescriptionLabel3 = new LabelComponent(
                "tradeName.detail.compositionStatementField.biotech.description3", "very-small-text");
        compositionStatementFieldDescriptionLabel4 = new LabelComponent(
                "tradeName.detail.compositionStatementField.biotech.description4", "very-small-text");
