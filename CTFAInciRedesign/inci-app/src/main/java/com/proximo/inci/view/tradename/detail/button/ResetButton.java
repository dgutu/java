...
public class ResetButton extends TradeNameDetailViewButton {

    public ResetButton(TradeNameDetailView parentView) {
        super(parentView);
    }

    @Override
    protected Button createMainComponentInstance() {
        return ComponentUtil.createActionButton("reset", parentView.getResetButtonListener());
    }
