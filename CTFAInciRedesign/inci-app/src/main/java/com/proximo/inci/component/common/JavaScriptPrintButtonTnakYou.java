...
public class JavaScriptPrintButtonTnakYou extends AbstractInciComponent<Button> {
    ...
    public JavaScriptPrintButtonTnakYou(AbstractPaymentOptionThankYouView parentView) {
        ...
        return ComponentUtil.createActionButton("print", new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
            	try {
	                ...
	                // remove HTML tags
	                String message = parentView.getThankYouText();
