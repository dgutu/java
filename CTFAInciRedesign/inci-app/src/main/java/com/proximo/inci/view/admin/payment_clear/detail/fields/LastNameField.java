...
public class LastNameField extends AbstractInciFieldComponent<TextField> {
    ...
    public LastNameField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.last_name"));
    }
