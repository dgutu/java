...
public class CasNumberField extends TradeNameColumnDetailsField<TextArea> {

    public CasNumberField(CasNumberFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        setValue(TemplarUtil.convertNonEnglishCharsToEnglish(getParentLayout().getParentColumnDetails()
                .getParentDetails().getParentView().getFormTn().CASNumber));
    }
