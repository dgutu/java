...
public class Address1Field extends AbstractInciFieldComponent<TextField> {
    ...
    public Address1Field(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.address"));
    }
