...
public class CompositionStatementField extends TradeNameColumnDetailsField<TextArea> {

    public CompositionStatementField(TradeNameColumnDetailsFieldLayout<?> parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        setValue(TemplarUtil.convertNonEnglishCharsToEnglish(getParentLayout().getParentColumnDetails()
                .getParentDetails().getParentView().getFormTn().compStmt));
    }

    @Override
    public String getFieldDescription() {
        return CaptionResolver.getCaption("tradeName.detail.compositionStatementField.DESC");
    }
