...
public class ChemicalSynonymsField extends TradeNameColumnDetailsField<TextArea> {

    public ChemicalSynonymsField(ChemicalSynonymsFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        setValue(TemplarUtil.convertNonEnglishCharsToEnglish(getParentLayout().getParentColumnDetails()
                .getParentDetails().getParentView().getFormTn().chemSynonyms));
    }
