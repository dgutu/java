...
public class PolymersSiliconsThirdColumnDetails extends TradeNameColumnDetails {
    ...
    public PolymersSiliconsThirdColumnDetails(PolymersSiliconsTradeNameDetails parentDetails) {
        super(parentDetails);
    }

    @Override
    protected void init() {
        nomenclatureFieldLayout = new NomenclatureFieldLayout(this, "155px", 5);
        otherFunctionsFieldLayout = new OtherFunctionsFieldLayout(this, 12);
        solventsOrDiluentsFieldLayout = new SolventsOrDiluentsFieldLayout(this, 15);
        adminCommentsFieldLayout = new AdminCommentsFieldLayout(this, 18);
    }
