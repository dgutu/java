...
public class TypeOfPreparationField extends TradeNameColumnDetailsField<TextArea> {

    public TypeOfPreparationField(TypeOfPreparationFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("tradeName.detail.typeOfPreparationField.DESC");
    }
}
