...
public class MonoIdField extends TradeNameColumnDetailsField<TextArea> {
    ...
    public void generateContent() {
        ...
        setValue(getParentLayout().getParentColumnDetails().getParentDetails().getParentView().getFormTn().monoId);
    }
