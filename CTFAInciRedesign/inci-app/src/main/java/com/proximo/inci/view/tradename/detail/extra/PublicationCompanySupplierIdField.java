...
public class PublicationCompanySupplierIdField extends TradeNameExtraDetailsField<TextField> {

    public PublicationCompanySupplierIdField(PublicationCompanySupplierIdFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    @Override
    protected void init() {
        mainComponent.setCaption(CaptionResolver.getCaption("view.trade_name.detail.publication_company_supplier_id"));
    }
    ...
    public void generateContent() {
        ...
        setValue(parentView.getFormTn().publicationCompanySupplierId);
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("view.trade_name.detail.publication_company_supplier_id.DESC");
    }
