...
public class Addr3Field extends UserField<TextField> {

    public Addr3Field(UserFieldsLeft parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        String address3 = getParentLayout().getParentForm().getParentLayout().getUser().getAddress3();        
