...
public class OtherFunctionsField extends TradeNameColumnDetailsField<TextArea> {

    public OtherFunctionsField(OtherFunctionsFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        setValue(TemplarUtil.convertNonEnglishCharsToEnglish(getParentLayout().getParentColumnDetails()
                .getParentDetails().getParentView().getFormTn().otherFunctions));
    }

    @Override
    public String getFieldDescription() {
        return CaptionResolver.getCaption("tradeName.detail.otherFunctionsField.DESC");
    }
