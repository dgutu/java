...
public class ProcessAfterFermentationField extends TradeNameColumnDetailsField<TextArea> {

    public ProcessAfterFermentationField(ProcessAfterFermentationFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("tradeName.detail.processAfterFermentationField.DESC");
    }
}
