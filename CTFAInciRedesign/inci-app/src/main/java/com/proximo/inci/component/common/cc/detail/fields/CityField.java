...
public class CityField extends AbstractInciFieldComponent<TextField> {
    ...
    public CityField(AbstractCreditCardDetailLayout creditCardDetailLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("credit_card.detail.city"));
    }

    @Override
    public void generateContent() {
        DOUserCC userCC = creditCardDetailLayout.getUserCC();
        if (userCC != null && !TemplarUtil.isStringNullOrEmpty(userCC.city)) {
            setValue(userCC.city);
        } else {
            setValue("");
        }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("credit_card.detail.city.DESC");
    }
