...
package com.proximo.inci.view.admin.ach_clear.search;
...
public class AchClearSearchView extends AbstractPaymentClearSearchView {

    public AchClearSearchView(MainWindow mainWindow) {
        super(mainWindow, true, "view.admin.ach_clearing.search");
    }

    @Override
    public ViewKey getDetailViewKey() {
        return ViewKey.ADMIN_ACH_CLEARING_DETAIL;
    }
    ...
    public DOList searchServiceCall(PaymentClearSearchParams searchParams) {
        return TradeNamePaymentService.getOnHoldTnFormsACH(searchParams);
    }
