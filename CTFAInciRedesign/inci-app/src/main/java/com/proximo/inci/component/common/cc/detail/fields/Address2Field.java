...
public class Address2Field extends AbstractInciFieldComponent<TextField> {

    private AbstractCreditCardDetailLayout creditCardDetailLayout;

    public Address2Field(AbstractCreditCardDetailLayout creditCardDetailLayout) {
    ...
    public void generateContent() {
        ...
        if (userCC != null && !TemplarUtil.isStringNullOrEmpty(userCC.address2)) {
            setValue(userCC.address2);
        } else {
            setValue("");
        }
