...
public class ReferenceField extends TradeNameColumnDetailsField<TextArea> {

    public ReferenceField(ReferenceFieldLayout parentLayout) {
        super(parentLayout);
    }
    ...
    public void generateContent() {
        ...
        setValue(TemplarUtil.convertNonEnglishCharsToEnglish(getParentLayout().getParentColumnDetails()
                .getParentDetails().getParentView().getFormTn().reference));
    }
