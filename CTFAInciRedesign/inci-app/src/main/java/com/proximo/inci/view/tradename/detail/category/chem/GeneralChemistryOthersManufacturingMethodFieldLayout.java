...
public class GeneralChemistryOthersManufacturingMethodFieldLayout extends
    ...
    public GeneralChemistryOthersManufacturingMethodFieldLayout(TradeNameColumnDetails parentColumnDetails) {
    ...
    protected void init() {
        ...
        manufacturingMethodFieldDescriptionLabel1 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description1", "very-small-text");
        manufacturingMethodFieldDescriptionLabel2 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description2", "very-small-text");
        manufacturingMethodFieldDescriptionLabel3 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description3", "very-small-text");
        manufacturingMethodFieldDescriptionLabel4 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description4", "very-small-text");
        manufacturingMethodFieldDescriptionLabel5 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description5", "very-small-text");
        manufacturingMethodFieldDescriptionLabel6 = new LabelComponent(
                "tradeName.detail.manufacturingMethodField.chem.description6", "very-small-text");
