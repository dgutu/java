...
public class ChangePaymentButton extends AbstractInciComponent<Button> {
    ...
    public ChangePaymentButton(PaymentByCCView parentView) {
    ...
    protected Button createMainComponentInstance() {
        return ComponentUtil.createActionButton("credit_card.detail.payment.change_payment_btn", new ClickListener() {
            @Override
