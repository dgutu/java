...
public class LastNameField extends AbstractInciFieldComponent<TextField> {

    private AbstractCreditCardDetailLayout creditCardDetailLayout;

    public LastNameField(AbstractCreditCardDetailLayout creditCardDetailLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("credit_card.detail.last_name"));
    }

    @Override
    public void generateContent() {
        DOUserCC userCC = creditCardDetailLayout.getUserCC();
        if (userCC != null && !TemplarUtil.isStringNullOrEmpty(userCC.lastName)) {
            setValue(userCC.lastName);
        } else {
            setValue("");
        }
    ...
    public String getFieldDescription() {
        return CaptionResolver.getCaption("credit_card.detail.last_name.DESC");
    }
