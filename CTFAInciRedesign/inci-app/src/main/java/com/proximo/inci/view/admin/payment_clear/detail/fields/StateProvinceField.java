...
public class StateProvinceField extends AbstractInciFieldComponent<TextField> {
    ...
    public StateProvinceField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.state_province"));
    }
