...
public class PhoneField extends AbstractInciFieldComponent<TextField> {
    ...
    public PhoneField(AbstractPaymentClearInfoLayout paymentClearInfoLayout) {
    ...
    protected void init() {
        ...
        mainComponent.setCaption(CaptionResolver.getCaption("view.admin.payment_clearing.detail.phone"));
    }
