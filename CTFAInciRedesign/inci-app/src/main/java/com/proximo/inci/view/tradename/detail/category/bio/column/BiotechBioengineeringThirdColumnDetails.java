...
public class BiotechBioengineeringThirdColumnDetails extends TradeNameColumnDetails {
    ...
    public BiotechBioengineeringThirdColumnDetails(BiotechBioengineeringTradeNameDetails parentDetails) {
        super(parentDetails);
    }
