...
public class EmailService {
	...
	public static void sendHtml(String from, String to, String subject, String html) throws MessagingException {
		...
		// InternetAddress("dgutu@proximo.com"));
	...
	public static void sendHtmlWithCC(String from, String to, String cc1, String cc2, String cc3, String subject,
	...
	public static void sendHtmlAttachement(String from, String to, String subject, String html, byte[] attachment)
		...
		// mimeMessage.addRecipient(Message.RecipientType.CC, new
		// InternetAddress("dgutu@proximo.com"));
		...
		// } catch(Exception ex) {
		// logger.error("sendHtmlAttachement error: " +
