...
@XmlRootElement(name = "WEBCentralizedShoppingCartMembershipGetPackageComponentListFromObject")
public class WEBCentralizedShoppingCartMembershipGetPackageComponentListFromObject {
