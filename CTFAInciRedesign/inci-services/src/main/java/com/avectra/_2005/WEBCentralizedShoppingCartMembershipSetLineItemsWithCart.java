 ...
 *         &lt;element name="MembershipKey" type="{http://microsoft.com/wsdl/types/}guid"/>
...
@XmlRootElement(name = "WEBCentralizedShoppingCartMembershipSetLineItemsWithCart")
public class WEBCentralizedShoppingCartMembershipSetLineItemsWithCart {

    protected CentralizedOrderEntryType oCentralizedOrderEntry;
    @XmlElement(name = "MembershipKey", required = true)
    ...
    /**
     * Gets the value of the membershipKey property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the membershipKey property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMembershipKey(String value) {
        this.membershipKey = value;
    }
