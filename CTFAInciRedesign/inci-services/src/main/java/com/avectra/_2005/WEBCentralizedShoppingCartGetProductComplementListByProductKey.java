...
@XmlRootElement(name = "WEBCentralizedShoppingCartGetProductComplementListByProductKey")
public class WEBCentralizedShoppingCartGetProductComplementListByProductKey {
