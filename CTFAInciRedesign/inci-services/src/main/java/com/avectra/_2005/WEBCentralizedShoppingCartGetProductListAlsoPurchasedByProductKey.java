...
@XmlRootElement(name = "WEBCentralizedShoppingCartGetProductListAlsoPurchasedByProductKey")
public class WEBCentralizedShoppingCartGetProductListAlsoPurchasedByProductKey {
