...
@XmlRootElement(name = "WEBCentralizedShoppingCartGetEventGuestRegistrantTypeListByEvent")
public class WEBCentralizedShoppingCartGetEventGuestRegistrantTypeListByEvent {
