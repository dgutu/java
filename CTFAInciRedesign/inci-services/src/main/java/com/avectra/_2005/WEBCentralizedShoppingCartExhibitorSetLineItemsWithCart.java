 ...
 *         &lt;element name="ExhibitorKey" type="{http://microsoft.com/wsdl/types/}guid"/>
...
@XmlRootElement(name = "WEBCentralizedShoppingCartExhibitorSetLineItemsWithCart")
public class WEBCentralizedShoppingCartExhibitorSetLineItemsWithCart {

    protected CentralizedOrderEntryType oCentralizedOrderEntry;
    @XmlElement(name = "ExhibitorKey", required = true)
    ...
    /**
     * Gets the value of the exhibitorKey property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the exhibitorKey property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setExhibitorKey(String value) {
        this.exhibitorKey = value;
    }
