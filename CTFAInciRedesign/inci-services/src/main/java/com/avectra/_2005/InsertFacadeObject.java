...
@XmlRootElement(name = "InsertFacadeObject")
public class InsertFacadeObject {

    protected String szObjectName;
    protected InsertFacadeObject.ONode oNode;
     ...
     * @return
     *     possible object is
     *     {@link InsertFacadeObject.ONode }
     *     
     */
    public InsertFacadeObject.ONode getONode() {
        return oNode;
    }
     ...
     *     
     */
    public void setONode(InsertFacadeObject.ONode value) {
        this.oNode = value;
    }
