...
@XmlRootElement(name = "WEBCentralizedShoppingCartGiftFundraisingSetLineItemsWithCart")
public class WEBCentralizedShoppingCartGiftFundraisingSetLineItemsWithCart {
