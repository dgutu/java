...
@XmlRootElement(name = "UpdateFacadeObject")
public class UpdateFacadeObject {

    @XmlElement(required = true, nillable = true)
    protected String szObjectName;
    protected String szObjectKey;
    protected UpdateFacadeObject.ONode oNode;
     ...
     * @return
     *     possible object is
     *     {@link UpdateFacadeObject.ONode }
     *     
     */
    public UpdateFacadeObject.ONode getONode() {
        return oNode;
    }
     ...
     *     
     */
    public void setONode(UpdateFacadeObject.ONode value) {
        this.oNode = value;
    }
