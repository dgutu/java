...
//************************************************************
/** Class that creates has codes.
* Copyright 1996 Aki Yoshida. All rights reserved.
* Modified by Iris Van den Broeke, Daniel Deville, April 2001
* Modified by Proximo Consulting for use with iSuite, January 2003
*
* The most common use of this class will be to construct it (most likely
* with a String or StringBuffer) and then call the getHashCode () method, or
* to call one of the two static getHashCode methods that take a String or StringBuffer.
*
* Original class name was UnixCrypt
*
...
{   
	...
	private final static String _ISUITE_SALT = "IS";
    ...
    public static String crypt(String key, String setting)
    {
		...
		// DR 1/7/03: change from a deprecated constructor of String
        try {
	        return new String(cryptresult, 0, 13, "UTF-8");
	...
	/************************************************************
	/**Static method to get a hash code from a String.  
	* Added by Proximo Consulting
	*/
    public static String  getHashCode (String s)
    {   
    	return crypt (s, _ISUITE_SALT);
   	}
	/************************************************************
	/**Static method to get a hash code from a StringBuffer
	* Added by Proximo Consulting
	*/
    public static String  getHashCode (StringBuffer s) { return getHashCode (s.toString ()); }

    /**********************************************************************
    /** Main can be used to get a hash value via a System call.  The only argument must be
     *  a String.
     *
     */
    static public void main (String args[])
    {
    	String c = Hash.getHashCode (args[0]);
